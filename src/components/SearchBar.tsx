...
const SearchBar = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-neutral-900/90 to-black/90 backdrop-blur-md border border-neutral-700/30 rounded-lg shadow-lg p-6 mb-4">
      <form onSubmit={handleSubmit}>
          ...
          >
            ...
            >
              ...
              {cities.map((city, index) => (
                <option key={index} value={city} className="text-white bg-neutral-800">
                  {city}
                </option>
              ))}
            </select>
          ...
          >
            ...
            >
              ...
              {propertyTypes.map((type, index) => (
                <option key={index} value={type} className="text-white bg-neutral-800">
                  {type}
                </option>
              ))}
            </select>
        ...
        <div className="mt-4">
          <button 
            ...
            className={`text-gray-300 hover:text-white font-medium text-sm flex items-center ${shouldAnimate ? 'transition-transform duration-200 hover:scale-105 active:scale-95' : ''}`}
          >
