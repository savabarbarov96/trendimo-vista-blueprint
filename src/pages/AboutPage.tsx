  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-background/80 flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero Section - Redesigned with adjusted spacing */}
        <section className="bg-background text-foreground relative overflow-hidden py-12 sm:py-16 px-4">
          {/* Background elements */}
          <div className="absolute inset-0 -z-10">
            <div className="absolute top-0 right-0 w-[70%] h-[60%] opacity-10 blur-[100px] bg-gradient-to-br from-primary/40 via-primary/20 to-background rounded-full transform translate-x-1/4 -translate-y-1/4" />
            <div className="absolute bottom-0 left-0 w-[50%] h-[50%] opacity-10 blur-[100px] bg-gradient-to-tr from-primary/30 via-primary/10 to-background rounded-full transform -translate-x-1/4 translate-y-1/4" />
          </div>
          ...
          <div className="container mx-auto max-w-5xl">
            <div className="flex flex-col items-center gap-6 text-center">
              ...
              <Badge variant="outline" className="animate-appear gap-2">
                ...
                <span className="text-muted-foreground">Недвижими имоти</span>
              </Badge>

              {/* Title */}
              <h1 className="text-4xl font-bold leading-tight sm:text-5xl md:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70 animate-appear">
                За Trendimo
              </h1>

              {/* Description */}
              <p className="text-lg max-w-[650px] text-muted-foreground animate-appear opacity-0 delay-100">
                Водеща компания за недвижими имоти с дългогодишен опит и отдадени професионалисти
              </p>

              {/* Actions */}
              <div className="flex flex-wrap justify-center gap-4 animate-appear opacity-0 delay-200">
                <Button
                  variant="default"
                  size="lg"
        ...
        {/* Story Scroll Section - adjusted spacing */}
        ...
        {/* Team Section - Replaced AnimatedTestimonials with static cards */}
