                    ...
                    <div className="mt-4 space-y-6">
                      ...
                      <div className="flex flex-col md:flex-row gap-4">
                        ...
                        <div className="flex-grow">
                          <h3 className="text-lg font-semibold mb-2 text-red-800">За мен</h3>
                          <div className="bg-red-50 p-3 rounded-md">
                            ...
                            {selectedMember.bio ? (
                              <p className="text-gray-700 text-sm whitespace-pre-line line-clamp-4">
                                {selectedMember.bio.length > 120 ? 
                                  `${selectedMember.bio.slice(0, 120)}...` : 
                                  selectedMember.bio}
                              </p>
                            ) : (
                      ...
                      {/* Bio section - full bio */}
                      {selectedMember.bio && selectedMember.bio.length > 0 && (
                        <div>
                          <h3 className="text-lg font-semibold mb-2 text-red-800">Биография</h3>
