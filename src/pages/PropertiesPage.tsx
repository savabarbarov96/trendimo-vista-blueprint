    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold mb-3 font-play bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-primary">
            Нашите Имоти
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-4">
              <div className="bg-gradient-to-r from-blue-50 to-white rounded-xl shadow-elegant p-4 border border-blue-100">
                <h3 className="text-lg font-semibold mb-4 text-blue-800">Филтри</h3>
                <PropertyFilter onFilterChange={handleFilterChange} />
              </div>
              
              {/* Demo section for file upload and gallery */}
              <div className="mt-8 p-4 bg-gradient-to-r from-blue-50 to-white rounded-xl shadow-elegant border border-blue-100">
